          ...
          <div class="col-sm-6 mb-3 mb-sm-0">
            <div class="card container">
              <div class="card-body">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal"><a href="motor.php" class="text-white" style="text-decoration: none;">Selengkapnya</a></button>
              </div>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="card container">
              <div class="card-body">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal"><a href="mobil.php" class="text-white" style="text-decoration: none;">Selengkapnya</a></button>
              </div>
            </div>
          </div>
        </div>
